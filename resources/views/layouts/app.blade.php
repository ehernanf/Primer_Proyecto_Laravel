...
<head>
  ...
  <link href="{{asset('demo/demo.css')}}../assets/" rel="stylesheet" />
</head>
...
@guest
        <li><a href="{{ route('login') }}" class="navbar-brand">Ingresar</a></li>
        <li><a href="{{ route('register') }} " class="navbar-brand">Registro</a></li>
    @else
        <li class="dropdown">
